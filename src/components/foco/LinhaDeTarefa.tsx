  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`group mb-2 flex cursor-grab select-none items-center gap-3 rounded-xl border-solid bg-bg-card px-4 py-2 transition-[border-color,background-color,opacity] duration-200 last:mb-0 hover:bg-bg-card-hover active:cursor-grabbing ${arrastada ? 'opacity-40' : ''}`}
        style={{
      ...
      >
        ...
        {vencimento && (
          <span
            ...
            style={{
              color: vencimento.atrasado ? 'var(--color-danger)' : 'var(--color-text-muted)',
            }}
